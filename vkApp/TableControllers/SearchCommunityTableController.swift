//
//  SearchCommunityTableController.swift
//  vkApp
//
...
class SearchCommunityTableController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.SearchCommunityLabel.text = searchCommunity[indexPath.row].name
        cell.SearchCommunityImage.image = searchCommunity[indexPath.row].image
